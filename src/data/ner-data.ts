...
export const districts: District[] = [
  ...
  // ARUNACHAL PRADESH
  { id: 'itanagar', name: 'Papum Pare', stateId: 'arunachal', lat: 27.0844, lng: 93.6053, population: 176573, area: 3462, accessibilityScore: 36, riskScore: 62, roadConnectivity: 52, railConnectivity: 25, airportAccess: 42, nearestHub: 'guwahati-hub', nearestHubDistance: 350, avgDeliveryTime: 24, avgTravelTime: 10, lastMileDifficulty: 'high', infrastructureQuality: 42, demandLevel: 45, elevation: 350, terrain: 'hilly' },
  { id: 'tawang', name: 'Tawang', stateId: 'arunachal', lat: 27.5860, lng: 91.8690, population: 49977, area: 2085, accessibilityScore: 17, riskScore: 82, roadConnectivity: 28, railConnectivity: 0, airportAccess: 10, nearestHub: 'guwahati-hub', nearestHubDistance: 520, avgDeliveryTime: 48, avgTravelTime: 18, lastMileDifficulty: 'very-high', infrastructureQuality: 25, demandLevel: 35, elevation: 3048, terrain: 'mountainous' },
  { id: 'west-kameng', name: 'West Kameng', stateId: 'arunachal', lat: 27.2340, lng: 92.3640, population: 87013, area: 7422, accessibilityScore: 19, riskScore: 78, roadConnectivity: 32, railConnectivity: 0, airportAccess: 12, nearestHub: 'guwahati-hub', nearestHubDistance: 420, avgDeliveryTime: 42, avgTravelTime: 15, lastMileDifficulty: 'very-high', infrastructureQuality: 28, demandLevel: 30, elevation: 1800, terrain: 'mountainous' },
  { id: 'east-siang', name: 'East Siang', stateId: 'arunachal', lat: 28.0690, lng: 95.3350, population: 99214, area: 4005, accessibilityScore: 23, riskScore: 70, roadConnectivity: 38, railConnectivity: 5, airportAccess: 20, nearestHub: 'dibrugarh-hub', nearestHubDistance: 280, avgDeliveryTime: 36, avgTravelTime: 14, lastMileDifficulty: 'very-high', infrastructureQuality: 30, demandLevel: 28, elevation: 420, terrain: 'hilly' },
  { id: 'changlang', name: 'Changlang', stateId: 'arunachal', lat: 27.1200, lng: 95.7400, population: 148226, area: 4662, accessibilityScore: 20, riskScore: 75, roadConnectivity: 30, railConnectivity: 8, airportAccess: 15, nearestHub: 'dibrugarh-hub', nearestHubDistance: 320, avgDeliveryTime: 40, avgTravelTime: 16, lastMileDifficulty: 'very-high', infrastructureQuality: 22, demandLevel: 32, elevation: 600, terrain: 'hilly' },
  { id: 'lower-subansiri', name: 'Lower Subansiri (Ziro)', stateId: 'arunachal', lat: 27.6000, lng: 93.8000, population: 83030, area: 3460, accessibilityScore: 20, riskScore: 72, roadConnectivity: 35, railConnectivity: 0, airportAccess: 18, nearestHub: 'guwahati-hub', nearestHubDistance: 400, avgDeliveryTime: 38, avgTravelTime: 14, lastMileDifficulty: 'very-high', infrastructureQuality: 26, demandLevel: 25, elevation: 1200, terrain: 'mountainous' },
  { id: 'dibang-valley', name: 'Dibang Valley (Anini)', stateId: 'arunachal', lat: 28.7900, lng: 95.9000, population: 7948, area: 9129, accessibilityScore: 12, riskScore: 84, roadConnectivity: 22, railConnectivity: 0, airportAccess: 8, nearestHub: 'dibrugarh-hub', nearestHubDistance: 405, avgDeliveryTime: 52, avgTravelTime: 20, lastMileDifficulty: 'very-high', infrastructureQuality: 20, demandLevel: 22, elevation: 1968, terrain: 'mountainous' },
  { id: 'lower-dibang', name: 'Lower Dibang Valley (Roing)', stateId: 'arunachal', lat: 28.1400, lng: 95.8300, population: 53986, area: 3900, accessibilityScore: 35, riskScore: 68, roadConnectivity: 48, railConnectivity: 5, airportAccess: 25, nearestHub: 'dibrugarh-hub', nearestHubDistance: 180, avgDeliveryTime: 24, avgTravelTime: 8, lastMileDifficulty: 'high', infrastructureQuality: 38, demandLevel: 36, elevation: 390, terrain: 'hilly' },
  { id: 'lohit', name: 'Lohit (Tezu)', stateId: 'arunachal', lat: 27.9100, lng: 96.1600, population: 145726, area: 2402, accessibilityScore: 33, riskScore: 65, roadConnectivity: 46, railConnectivity: 5, airportAccess: 30, nearestHub: 'dibrugarh-hub', nearestHubDistance: 210, avgDeliveryTime: 26, avgTravelTime: 9, lastMileDifficulty: 'high', infrastructureQuality: 36, demandLevel: 34, elevation: 210, terrain: 'hilly' },

  // MANIPUR
  { id: 'imphal-west', name: 'Imphal West', stateId: 'manipur', lat: 24.8074, lng: 93.9384, population: 517992, area: 519, accessibilityScore: 57, riskScore: 48, roadConnectivity: 68, railConnectivity: 15, airportAccess: 70, nearestHub: 'imphal-hub', nearestHubDistance: 5, avgDeliveryTime: 10, avgTravelTime: 6, lastMileDifficulty: 'medium', infrastructureQuality: 58, demandLevel: 70, elevation: 786, terrain: 'hilly' },
  { id: 'imphal-east', name: 'Imphal East', stateId: 'manipur', lat: 24.8500, lng: 94.0500, population: 452661, area: 710, accessibilityScore: 53, riskScore: 50, roadConnectivity: 62, railConnectivity: 10, airportAccess: 65, nearestHub: 'imphal-hub', nearestHubDistance: 12, avgDeliveryTime: 11, avgTravelTime: 6.5, lastMileDifficulty: 'medium', infrastructureQuality: 52, demandLevel: 62, elevation: 790, terrain: 'hilly' },
  { id: 'churachandpur', name: 'Churachandpur', stateId: 'manipur', lat: 24.3340, lng: 93.6840, population: 274143, area: 4570, accessibilityScore: 29, riskScore: 72, roadConnectivity: 30, railConnectivity: 0, airportAccess: 15, nearestHub: 'imphal-hub', nearestHubDistance: 60, avgDeliveryTime: 32, avgTravelTime: 12, lastMileDifficulty: 'very-high', infrastructureQuality: 25, demandLevel: 38, elevation: 1500, terrain: 'mountainous' },
  { id: 'ukhrul', name: 'Ukhrul', stateId: 'manipur', lat: 25.1200, lng: 94.3600, population: 183998, area: 4544, accessibilityScore: 27, riskScore: 74, roadConnectivity: 28, railConnectivity: 0, airportAccess: 12, nearestHub: 'imphal-hub', nearestHubDistance: 85, avgDeliveryTime: 36, avgTravelTime: 14, lastMileDifficulty: 'very-high', infrastructureQuality: 22, demandLevel: 30, elevation: 1662, terrain: 'mountainous' },

  // MEGHALAYA
  { id: 'east-khasi', name: 'East Khasi Hills', stateId: 'meghalaya', lat: 25.5788, lng: 91.8933, population: 825922, area: 2748, accessibilityScore: 62, riskScore: 48, roadConnectivity: 72, railConnectivity: 15, airportAccess: 62, nearestHub: 'shillong-hub', nearestHubDistance: 5, avgDeliveryTime: 8, avgTravelTime: 4, lastMileDifficulty: 'medium', infrastructureQuality: 62, demandLevel: 68, elevation: 1496, terrain: 'hilly' },
  { id: 'west-garo', name: 'West Garo Hills', stateId: 'meghalaya', lat: 25.5200, lng: 90.2200, population: 643291, area: 3714, accessibilityScore: 34, riskScore: 58, roadConnectivity: 48, railConnectivity: 8, airportAccess: 30, nearestHub: 'shillong-hub', nearestHubDistance: 320, avgDeliveryTime: 18, avgTravelTime: 9, lastMileDifficulty: 'high', infrastructureQuality: 40, demandLevel: 52, elevation: 380, terrain: 'hilly' },
  { id: 'ri-bhoi', name: 'Ri-Bhoi', stateId: 'meghalaya', lat: 25.7700, lng: 91.8500, population: 258840, area: 2448, accessibilityScore: 54, riskScore: 45, roadConnectivity: 65, railConnectivity: 12, airportAccess: 48, nearestHub: 'shillong-hub', nearestHubDistance: 45, avgDeliveryTime: 10, avgTravelTime: 4.5, lastMileDifficulty: 'medium', infrastructureQuality: 52, demandLevel: 45, elevation: 800, terrain: 'hilly' },
  { id: 'south-garo', name: 'South Garo Hills', stateId: 'meghalaya', lat: 25.2800, lng: 90.6200, population: 142574, area: 1850, accessibilityScore: 23, riskScore: 65, roadConnectivity: 35, railConnectivity: 0, airportAccess: 15, nearestHub: 'shillong-hub', nearestHubDistance: 380, avgDeliveryTime: 28, avgTravelTime: 12, lastMileDifficulty: 'very-high', infrastructureQuality: 28, demandLevel: 35, elevation: 450, terrain: 'hilly' },

  // MIZORAM
  { id: 'aizawl-dist', name: 'Aizawl', stateId: 'mizoram', lat: 23.7271, lng: 92.7176, population: 404054, area: 3576, accessibilityScore: 49, riskScore: 55, roadConnectivity: 55, railConnectivity: 0, airportAccess: 55, nearestHub: 'aizawl-hub', nearestHubDistance: 5, avgDeliveryTime: 16, avgTravelTime: 10, lastMileDifficulty: 'high', infrastructureQuality: 48, demandLevel: 55, elevation: 1132, terrain: 'mountainous' },
  { id: 'lunglei', name: 'Lunglei', stateId: 'mizoram', lat: 22.8800, lng: 92.7300, population: 161428, area: 4538, accessibilityScore: 24, riskScore: 68, roadConnectivity: 30, railConnectivity: 0, airportAccess: 12, nearestHub: 'aizawl-hub', nearestHubDistance: 180, avgDeliveryTime: 36, avgTravelTime: 14, lastMileDifficulty: 'very-high', infrastructureQuality: 25, demandLevel: 32, elevation: 850, terrain: 'mountainous' },
  { id: 'champhai', name: 'Champhai', stateId: 'mizoram', lat: 23.4567, lng: 93.3280, population: 125370, area: 3185, accessibilityScore: 25, riskScore: 65, roadConnectivity: 32, railConnectivity: 0, airportAccess: 10, nearestHub: 'aizawl-hub', nearestHubDistance: 190, avgDeliveryTime: 34, avgTravelTime: 13, lastMileDifficulty: 'very-high', infrastructureQuality: 28, demandLevel: 28, elevation: 1678, terrain: 'mountainous' },

  // NAGALAND
  { id: 'kohima', name: 'Kohima', stateId: 'nagaland', lat: 25.6747, lng: 94.1086, population: 267988, area: 1463, accessibilityScore: 45, riskScore: 58, roadConnectivity: 55, railConnectivity: 0, airportAccess: 30, nearestHub: 'dimapur-hub', nearestHubDistance: 74, avgDeliveryTime: 14, avgTravelTime: 7, lastMileDifficulty: 'high', infrastructureQuality: 48, demandLevel: 55, elevation: 1444, terrain: 'mountainous' },
  { id: 'dimapur', name: 'Dimapur', stateId: 'nagaland', lat: 25.8973, lng: 93.7266, population: 378811, area: 927, accessibilityScore: 69, riskScore: 42, roadConnectivity: 70, railConnectivity: 72, airportAccess: 60, nearestHub: 'dimapur-hub', nearestHubDistance: 3, avgDeliveryTime: 8, avgTravelTime: 5, lastMileDifficulty: 'low', infrastructureQuality: 58, demandLevel: 68, elevation: 154, terrain: 'plain' },
  { id: 'mon', name: 'Mon', stateId: 'nagaland', lat: 26.6919, lng: 94.9130, population: 250260, area: 1786, accessibilityScore: 20, riskScore: 75, roadConnectivity: 25, railConnectivity: 0, airportAccess: 8, nearestHub: 'dimapur-hub', nearestHubDistance: 340, avgDeliveryTime: 42, avgTravelTime: 16, lastMileDifficulty: 'very-high', infrastructureQuality: 18, demandLevel: 28, elevation: 900, terrain: 'mountainous' },
  { id: 'tuensang', name: 'Tuensang', stateId: 'nagaland', lat: 26.2700, lng: 94.8300, population: 196801, area: 4228, accessibilityScore: 16, riskScore: 78, roadConnectivity: 22, railConnectivity: 0, airportAccess: 5, nearestHub: 'dimapur-hub', nearestHubDistance: 360, avgDeliveryTime: 44, avgTravelTime: 18, lastMileDifficulty: 'very-high', infrastructureQuality: 15, demandLevel: 25, elevation: 1400, terrain: 'mountainous' },

  // SIKKIM
  { id: 'east-sikkim', name: 'East Sikkim', stateId: 'sikkim', lat: 27.3389, lng: 88.6065, population: 283583, area: 954, accessibilityScore: 50, riskScore: 55, roadConnectivity: 65, railConnectivity: 18, airportAccess: 52, nearestHub: 'siliguri-hub', nearestHubDistance: 120, avgDeliveryTime: 12, avgTravelTime: 6, lastMileDifficulty: 'high', infrastructureQuality: 55, demandLevel: 58, elevation: 1650, terrain: 'mountainous' },
  { id: 'north-sikkim', name: 'North Sikkim', stateId: 'sikkim', lat: 27.8500, lng: 88.5500, population: 43354, area: 4226, accessibilityScore: 17, riskScore: 85, roadConnectivity: 20, railConnectivity: 0, airportAccess: 8, nearestHub: 'siliguri-hub', nearestHubDistance: 280, avgDeliveryTime: 48, avgTravelTime: 18, lastMileDifficulty: 'very-high', infrastructureQuality: 15, demandLevel: 15, elevation: 4500, terrain: 'mountainous' },
  { id: 'south-sikkim', name: 'South Sikkim', stateId: 'sikkim', lat: 27.1300, lng: 88.4100, population: 146850, area: 750, accessibilityScore: 41, riskScore: 60, roadConnectivity: 50, railConnectivity: 10, airportAccess: 35, nearestHub: 'siliguri-hub', nearestHubDistance: 150, avgDeliveryTime: 16, avgTravelTime: 8, lastMileDifficulty: 'high', infrastructureQuality: 42, demandLevel: 38, elevation: 1500, terrain: 'mountainous' },
  { id: 'west-sikkim', name: 'West Sikkim', stateId: 'sikkim', lat: 27.2000, lng: 88.2500, population: 136435, area: 1166, accessibilityScore: 28, riskScore: 70, roadConnectivity: 38, railConnectivity: 0, airportAccess: 15, nearestHub: 'siliguri-hub', nearestHubDistance: 200, avgDeliveryTime: 24, avgTravelTime: 12, lastMileDifficulty: 'very-high', infrastructureQuality: 30, demandLevel: 28, elevation: 2200, terrain: 'mountainous' },
...
// Synchronize all district accessibility scores with the single canonical computeAccessibility engine
districts.forEach(d => {
  d.accessibilityScore = computeAccessibility(d).overallScore;
});

// Synchronize state accessibilityScore with the mean of canonical district scores
states.forEach(s => {
  const sDistricts = districts.filter(d => d.stateId === s.id);
  if (sDistricts.length > 0) {
    s.accessibilityScore = Math.round(sDistricts.reduce((sum, d) => sum + d.accessibilityScore, 0) / sDistricts.length);
  }
});
...
export const graphEdges: GraphEdge[] = [
  ...
  { from: 'bomdila', to: 'tawang', distance: 180, time: 7.0, cost: 6.0, risk: 82, accessibility: 17, roadId: 'nh-13', roadName: 'NH-13', condition: 'poor', waypoints: [[27.27, 92.42], [27.4, 92.1], [27.59, 91.87]] },
  ...
  { from: 'roing', to: 'anini', distance: 225, time: 6.5, cost: 6.5, risk: 84, accessibility: 12, roadId: 'nh-313', roadName: 'NH-313 (Roing-Anini Highway via Hunli & Mayodia)', condition: 'fair', waypoints: [[28.14, 95.83], [28.23, 95.91], [28.52, 95.96], [28.79, 95.90]] },
