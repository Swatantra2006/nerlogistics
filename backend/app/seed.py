...
DISTRICTS_DATA = [
    ...
    {"id": "lower-subansiri", "name": "Lower Subansiri (Ziro)", "state_id": "arunachal", "lat": 27.6000, "lng": 93.8000, "population": 83030, "area": 3460, "accessibility_score": 30, "risk_score": 72, "road_connectivity": 35, "rail_connectivity": 0, "airport_access": 18, "nearest_hub": "guwahati-hub", "nearest_hub_distance": 400, "avg_delivery_time": 38, "avg_travel_time": 14, "last_mile_difficulty": "very-high", "infrastructure_quality": 26, "demand_level": 25, "elevation": 1200, "terrain": "mountainous"},
    {"id": "dibang-valley", "name": "Dibang Valley (Anini)", "state_id": "arunachal", "lat": 28.7900, "lng": 95.9000, "population": 7948, "area": 9129, "accessibility_score": 18, "risk_score": 84, "road_connectivity": 22, "rail_connectivity": 0, "airport_access": 8, "nearest_hub": "dibrugarh-hub", "nearest_hub_distance": 405, "avg_delivery_time": 52, "avg_travel_time": 20, "last_mile_difficulty": "very-high", "infrastructure_quality": 20, "demand_level": 22, "elevation": 1968, "terrain": "mountainous"},
    {"id": "lower-dibang", "name": "Lower Dibang Valley (Roing)", "state_id": "arunachal", "lat": 28.1400, "lng": 95.8300, "population": 53986, "area": 3900, "accessibility_score": 42, "risk_score": 68, "road_connectivity": 48, "rail_connectivity": 5, "airport_access": 25, "nearest_hub": "dibrugarh-hub", "nearest_hub_distance": 180, "avg_delivery_time": 24, "avg_travel_time": 8, "last_mile_difficulty": "high", "infrastructure_quality": 38, "demand_level": 36, "elevation": 390, "terrain": "hilly"},
    # MANIPUR
...
GRAPH_NODES_DATA = [
    ...
    {"id": "anini", "name": "Anini", "lat": 28.7900, "lng": 95.9000, "state_id": "arunachal"},
    {"id": "roing", "name": "Roing", "lat": 28.1400, "lng": 95.8300, "state_id": "arunachal"},
    {"id": "tezu", "name": "Tezu", "lat": 27.9100, "lng": 96.1600, "state_id": "arunachal"},
    {"id": "ziro", "name": "Ziro", "lat": 27.5300, "lng": 93.8300, "state_id": "arunachal"},
]
...
GRAPH_EDGES_DATA = [
    ...
    {"from_node": "tinsukia", "to_node": "roing", "distance": 95, "time": 2.2, "cost": 3.5, "risk": 45, "accessibility": 55, "road_id": "nh-115", "road_name": "NH-115 (via Bhupen Hazarika Setu)", "condition": "good", "waypoints": [[27.49, 95.35], [27.78, 95.66], [28.14, 95.83]]},
    {"from_node": "roing", "to_node": "anini", "distance": 225, "time": 6.5, "cost": 6.5, "risk": 84, "accessibility": 18, "road_id": "nh-313", "road_name": "NH-313 (Roing-Anini Highway via Hunli & Mayodia)", "condition": "fair", "waypoints": [[28.14, 95.83], [28.23, 95.91], [28.52, 95.96], [28.79, 95.90]]},
    {"from_node": "roing", "to_node": "pasighat", "distance": 85, "time": 2.0, "cost": 3.8, "risk": 48, "accessibility": 48, "road_id": "nh-13", "road_name": "NH-13 (Trans-Arunachal Highway)", "condition": "good", "waypoints": [[28.14, 95.83], [28.10, 95.55], [28.07, 95.33]]},
    {"from_node": "roing", "to_node": "tezu", "distance": 65, "time": 1.5, "cost": 3.5, "risk": 42, "accessibility": 52, "road_id": "nh-13", "road_name": "NH-13", "condition": "good", "waypoints": [[28.14, 95.83], [27.98, 96.00], [27.91, 96.16]]},
    {"from_node": "itanagar", "to_node": "ziro", "distance": 110, "time": 3.8, "cost": 4.2, "risk": 62, "accessibility": 38, "road_id": "nh-13", "road_name": "NH-13 (Potin-Ziro)", "condition": "fair", "waypoints": [[27.08, 93.61], [27.3, 93.7], [27.53, 93.83]]},
]
